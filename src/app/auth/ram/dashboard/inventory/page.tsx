...
export default function InventoryPage() {
  ...
  const [activeModal, setActiveModal] = useState<'add-book' | 'add-inventory' | 'view-inventory' | null>(null);
      ...
      <div className="p-6 space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          <button
            ...
            className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow space-y-4"
          >
            ...
            <p className="text-gray-600">Add new books to your catalog</p>
          </button>
          ...
          >
            ...
            <p className="text-gray-600">Add stock to existing books</p>
          </button>

          <button
            onClick={() => setActiveModal('view-inventory')}
            className="p-6 bg-white rounded-xl shadow-lg hover:shadow-xl transition-shadow space-y-4"
          >
            ...
            <p className="text-gray-600">Check current stock levels</p>
          </button>
        </div>
            ...
            <div className="bg-white rounded-xl p-6 max-w-md w-full max-h-[90vh] overflow-y-auto">
              <div className="flex justify-between items-center mb-4">
                <h3 className="text-lg font-semibold">
                  ...
                  {activeModal === 'view-inventory' && 'Current Inventory'}
                </h3>
                <button

      ...
      {/* <section className="relative w-full flex flex-col items-center justify-center py-16 md:py-24 bg-gradient-to-br from-yellow-100 via-blue-50 to-pink-50 overflow-hidden">
        ...
        >
          ...
          <div className="flex flex-col md:flex-row gap-4 justify-center items-center w-full mb-2">
            ...
            <a href="/quiz">
              <button className="w-full md:w-auto py-3 px-6 rounded-xl border-2 border-pink-400 text-pink-700 font-bold shadow-lg hover:scale-105 hover:border-yellow-400 transition flex items-center gap-2 bg-white">Ram Navami Quiz</button>
            </a>
            <a href="/quiz/gift">
              <button className="w-full md:w-auto py-3 px-6 rounded-xl border-2 border-pink-400 text-pink-700 font-bold shadow-lg hover:scale-105 hover:border-yellow-400 transition flex items-center gap-2 bg-white">Claim Ram Navami Gift</button>
            </a>
      ...
      <section className="relative w-full flex flex-col items-center justify-center py-16 md:py-24 bg-gradient-to-br from-yellow-100 via-blue-50 to-pink-50 overflow-hidden">
        ...
        >
          ...
          <GlowingButton className="text-lg">Hare Krishna 🙏</GlowingButton>
            <a href="/jm-quiz1">
              <button className="w-full md:w-auto py-3 px-6 rounded-xl border-2 border-pink-400 text-pink-700 font-bold shadow-lg hover:scale-105 hover:border-yellow-400 transition flex items-center gap-2 bg-white">Krishna Quest 1</button>
            </a>
            <a href="/jm-quiz2">
              <button className="w-full md:w-auto py-3 px-6 rounded-xl border-2 border-pink-400 text-pink-700 font-bold shadow-lg hover:scale-105 hover:border-yellow-400 transition flex items-center gap-2 bg-white">Krishna Quest 2</button>
            </a>
            <a href="https://mybhakticonnectt.netlify.app/" className="px-6 py-3 rounded-xl font-bold text-white bg-gradient-to-r from-green-500 via-yellow-400 to-pink-400 shadow-lg hover:scale-105 transition flex items-center gap-2"> Bhakti Kit</a>
          </div>
        </motion.div>
      </section>
